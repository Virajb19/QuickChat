...
import { Loader, Plus, CircleAlert, CheckCheck } from "lucide-react";
                ...
                <Form {...form}>
                    <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
                      ...
                      <FormField
                          ...
                          render={({ field }) => (
                             <FormItem className='flex flex-col gap-1'>
                              ...
                              <FormControl>
                                ...
                                }} className='outline-none dark:bg-black px-4 py-3 placeholder:text-lg placeholder:font-semibold rounded-md focus:outline-none border focus:border-transparent focus:ring-[3px] focus:ring-blue-600 duration-200' placeholder='Enter passcode of the chat'/>
                              </FormControl>
                             {passcode.length === 6 && (
                        ...
                        <button disabled={form.formState.isSubmitting || isFetching || isPasscodeAvailable === false} type="submit" className="flex-center gap-2 w-full bg-blue-700 hover:bg-blue-600 duration-200 rounded-lg py-2 px-5 text-lg font-semibold disabled:opacity-70 disabled:cursor-not-allowed">
